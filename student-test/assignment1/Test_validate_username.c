...
void test_validate_my_username()
{
    ...
    const char *conf_username, *hardcode_username; 
    conf_username = malloc_username_from_conf_file();
    hardcode_username = my_username();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcode_username, conf_username, "UserName test Failed!!!");
}
